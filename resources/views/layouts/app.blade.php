            ...
            <div class="fixed inset-0 flex">
                ...
                <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform"
                    ...
                    <div x-show="open" x-transition:enter="ease-in-out duration-300"
                        ...
                        class="absolute top-0 left-full flex w-16 justify-center pt-5" style="display: none;">
                            ...
                            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                <li>
                                    <ul role="list" class="-mx-2 space-y-1">
                                        <li>
                                            <a href="#"
                                                class="bg-indigo-700 text-white group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold"
                                        ...
                                        <li>
                                            <a href="#"
                                                class="text-indigo-200 hover:text-white hover:bg-indigo-700 group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold"
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <div x-data="Components.menu({ open: false })" x-init="init()"
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                ...
                                <a href="#" class="block px-3 py-1 text-sm/6 text-gray-900" x-state:on="Active"
                                    x-state:off="Not Active"
                                    :class="{ 'bg-gray-50 outline-hidden': activeIndex === 0 }" role="menuitem"
                                ...
                                <a href="#" class="block px-3 py-1 text-sm/6 text-gray-900"
                                    :class="{ 'bg-gray-50 outline-hidden': activeIndex === 1 }" role="menuitem"
