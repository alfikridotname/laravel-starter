            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <p class="mt-2 text-sm/6 text-gray-500">
                        {{ __('Not a member?') }}
                        <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">{{ __('Sign Up') }}</a>
                    </p>
                </div>
                ...
                <div class="mt-10">
                                ...
                                <div class="relative mt-2">
                                    ...
                                    <button type="button" @click="showPassword = !showPassword"
                                        ...
                                        <svg x-show="showPassword" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7 1.021-3.25 3.73-5.919 7.057-6.762m3.856.823A3.978 3.978 0 0116 12c0 1.657-1.343 3-3 3-1.179 0-2.191-.689-2.743-1.684M15.375 8.325A10.05 10.05 0 0112 5c-4.478 0-8.268 2.943-9.542 7 .303.972.732 1.883 1.268 2.707m3.506-3.49A3.978 3.978 0 0012 12c1.657 0 3-1.343 3-3 0-1.179-.689-2.191-1.684-2.743" />
                                        </svg>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex gap-3">
                                    ...
                                    <label for="remember-me"
                                        class="block text-sm/6 text-gray-900">{{ __('Remember me') }}</label>
                                </div>
                    ...
                    <div class="mt-10">
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-4">
                            ...
                            <a href="#"
                                class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent">
                                <svg class="size-5 fill-[#24292F]" fill="currentColor" viewBox="0 0 20 20"
                                    aria-hidden="true">
